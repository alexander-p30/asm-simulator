...
prompt_fname_msg db 'Digite o nome do arquivo: '
prompt_fname_msg_size equ $-prompt_fname_msg

prompt_fsize_msg db '=====================', LINE_BR, 'O arquivo de saida ocupa, em bytes: '
prompt_fsize_msg_size equ $-prompt_fsize_msg
...
_start:
				mov eax, 4
				mov ebx, 1
				mov ecx, prompt_fname_msg
				mov edx, prompt_fname_msg_size
				int 80h
...
run_stop:
				...
				mov eax, 4
				mov ebx, 1
				mov ecx, prompt_fsize_msg
				mov edx, prompt_fsize_msg_size
				int 80h

				push dword [output_file_size]
				call print_int
				add ESP, 4
